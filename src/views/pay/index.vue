<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div v-if="selectAddress" class="info">
...
<script>
import { getAddressList } from '@/api/cart'
...
export default {
  ...
  computed: {
    ...
    longAddress () {
      const region = this.selectAddress.data.detail.region
      return region.province + region.city + region.region + this.selectAddress.data.detail.detail
    },
    mode () {
